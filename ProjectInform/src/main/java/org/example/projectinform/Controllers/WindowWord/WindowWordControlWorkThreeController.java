...
public class WindowWordControlWorkThreeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        SwitchWindowSMC.switchWindow(lastWindow, FXMLPath.WINDOW_WORD_THREE);
        SwitchWindowSMC.switchWindow(nextWindow, FXMLPath.WINDOW_WORD_FOUR);

        TaskWorkerSMC.switchInfoWord(enterWorkControl, FXMLPath.WINDOW_WORD_INFO_TASK, WordTaskPaths.CW3);
