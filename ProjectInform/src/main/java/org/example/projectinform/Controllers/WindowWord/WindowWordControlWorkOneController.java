...
public class WindowWordControlWorkOneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        SwitchWindowSMC.switchWindow(lastWindow, FXMLPath.WINDOW_WORD_ONE);
        SwitchWindowSMC.switchWindow(nextWindow, FXMLPath.WINDOW_WORD_TWO);

        TaskWorkerSMC.switchInfoWord(enterWorkControl, FXMLPath.WINDOW_WORD_INFO_TASK, WordTaskPaths.CW1);
