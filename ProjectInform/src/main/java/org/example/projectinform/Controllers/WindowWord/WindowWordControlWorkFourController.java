...
public class WindowWordControlWorkFourController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        SpecialMethodsClass.switchWindow(nextWindow, DictionaryPath.WINDOW_WORD_FIVE);

        SpecialMethodsClass.switchWindow(lastWindow, DictionaryPath.WINDOW_WORD_FOUR);
